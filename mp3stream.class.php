    ...
    private function decodeMP3Header($strFrame) {
        if (strlen($strFrame) < 4) {
            ...
            switch (($arrHeader[1] >> 3) & 3) {
                case 0 : $arrInfos['version'] = '2.5'; break;
                case 1 : throw new MP3StreamException("Header: reserved version"); break;
                case 2 : $arrInfos['version'] = '2'; break;
                case 3 : $arrInfos['version'] = '1'; break;
            }

            // LAYER ID
            switch (($arrHeader[1] >> 1) & 3) {
                case 0 : throw new MP3StreamException("Header: reserved layer ID"); break;
                case 1 : $arrInfos['layer'] = 'III'; break;
                case 2 : $arrInfos['layer'] = 'II'; break;
                case 3 : $arrInfos['layer'] = 'I'; break;
            }
            ...
            switch ($arrHeader[3] >> 6) {
                case 0 : $arrInfos['mode'] = 'stereo'; break;
                case 1 : $arrInfos['mode'] = 'joint stereo'; break;
                case 2 : $arrInfos['mode'] = 'dual channel'; break;
                case 3 : $arrInfos['mode'] = 'single channel'; break;
            }
            ...
            switch ($arrHeader[3] & 3) {
                case 0 : $arrInfos['emphasis'] = 'none'; break;
                case 1 : $arrInfos['emphasis'] = '50/15 ms'; break;
                case 2 : throw new MP3StreamException("Header: unexpected emphase"); break;
                case 3 : $arrInfos['emphasis'] = 'CCITT J.17'; break;
            }
